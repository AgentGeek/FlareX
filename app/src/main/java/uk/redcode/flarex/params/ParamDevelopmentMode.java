...
public class ParamDevelopmentMode extends uk.redcode.flarex.object.Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/development_mode
    private static final String KEY = "development_mode";
    private static final String TAG = "Param-DevelopmentMode";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.development_mode);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.development_mode_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamDevelopmentMode.this);
