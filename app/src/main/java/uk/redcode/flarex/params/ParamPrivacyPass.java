...
public class ParamPrivacyPass extends uk.redcode.flarex.object.Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/privacy_pass
    private static final String KEY = "privacy_pass";
    private static final String TAG = "Param-PrivacyPass";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.privacy_pass);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.privacy_pass_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamPrivacyPass.this);
