...
public class ParamServersideExcludes extends uk.redcode.flarex.object.Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/server_side_exclude
    private static final String KEY = "server_side_exclude";
    private static final String TAG = "Param-ServersideExcludes";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.server_side_exclude);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.server_side_exclude_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamServersideExcludes.this);
