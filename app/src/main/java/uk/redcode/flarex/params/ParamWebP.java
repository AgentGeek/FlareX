...
public class ParamWebP extends uk.redcode.flarex.object.Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/webp
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.webp);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.webp_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamWebP.this);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        setSetting(KEY, Parser.convertBoolean(isChecked), new CFApi.JSONListener() {
            ...
            @Override
            public void onError(Exception e) {
                reverse(paramSwitch, ParamWebP.this);
                setError(true);
                setLoading(false);
            }
        });
