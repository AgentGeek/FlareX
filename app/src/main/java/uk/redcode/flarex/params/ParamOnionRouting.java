...
public class ParamOnionRouting extends uk.redcode.flarex.object.Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/opportunistic_onion
    private static final String KEY = "opportunistic_onion";
    private static final String TAG = "Param-OnionRouting";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.onion_routing);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.onion_routing_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamOnionRouting.this);
