...
public class ParamHTTPSRewrites extends Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/automatic_https_rewrites
    private static final String KEY = "automatic_https_rewrites";
    private static final String TAG = "Param-HTTPSRewrite";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.https_rewrites);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.https_rewrites_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamHTTPSRewrites.this);
