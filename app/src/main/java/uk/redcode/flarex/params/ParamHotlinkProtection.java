...
public class ParamHotlinkProtection extends uk.redcode.flarex.object.Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/hotlink_protection
    private static final String KEY = "hotlink_protection";
    private static final String TAG = "Param-HotlinkProtection";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.hotlink_protection);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.hotlink_protection_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamHotlinkProtection.this);
