...
public class ParamOpportunisticEncryption extends Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/opportunistic_encryption
    private static final String KEY = "opportunistic_encryption";
    private static final String TAG = "Param-OpportunisticEncryption";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.opportunistic_encryption);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.opportunistic_encryption_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamOpportunisticEncryption.this);
