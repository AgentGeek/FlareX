...
public class ParamAlwaysOnline extends uk.redcode.flarex.object.Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/always_online
    private static final String KEY = "always_online";
    private static final String TAG = "Param-AlwaysOnline";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.always_online);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.always_online_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamAlwaysOnline.this);
