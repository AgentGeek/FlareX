...
public class ParamIPv6 extends uk.redcode.flarex.object.Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/ipv6
    private static final String KEY = "ipv6";
    private static final String TAG = "Param-IPv6";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.ipv6_compatibility);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.ipv6_compatibility_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamIPv6.this);
