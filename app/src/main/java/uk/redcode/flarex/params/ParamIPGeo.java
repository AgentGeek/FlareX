...
public class ParamIPGeo extends uk.redcode.flarex.object.Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/ip_geolocation
    private static final String KEY = "ip_geolocation";
    private static final String TAG = "Param-IPGeo";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.ip_geo);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.ip_geo_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamIPGeo.this);
