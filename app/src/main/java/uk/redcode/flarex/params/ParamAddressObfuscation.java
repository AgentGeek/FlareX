...
public class ParamAddressObfuscation extends uk.redcode.flarex.object.Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/email_obfuscation
    private static final String KEY = "email_obfuscation";
    private static final String TAG = "Param-EmailObfuscation";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.email_obfuscation);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.email_obfuscation_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamAddressObfuscation.this);
