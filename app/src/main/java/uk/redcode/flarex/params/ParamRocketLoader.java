...
public class ParamRocketLoader extends Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/rocket_loader
    private static final String KEY = "rocket_loader";
    private static final String TAG = "Param-RockerLoader";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.rocket_loader);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.rocket_loader_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamRocketLoader.this);
