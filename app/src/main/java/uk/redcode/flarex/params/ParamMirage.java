...
public class ParamMirage extends uk.redcode.flarex.object.Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/mirage
    private static final String KEY = "mirage";
    private static final String TAG = "Param-Mirage";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.mirage);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.mirage_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamMirage.this);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        setSetting(KEY, Parser.convertBoolean(isChecked), new CFApi.JSONListener() {
            ...
            @Override
            public void onError(Exception e) {
                reverse(paramSwitch, ParamMirage.this);
                setError(true);
