...
public class ParamHTTP3 extends uk.redcode.flarex.object.Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/http3
    private static final String KEY = "http3";
    private static final String TAG = "Param-HTTP3";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.http3);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.http3_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamHTTP3.this);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        setSetting(KEY, Parser.convertBoolean(isChecked), new CFApi.JSONListener() {
            ...
            @Override
            public void onError(Exception e) {
                reverse(paramSwitch, ParamHTTP3.this);
                setError(true);
