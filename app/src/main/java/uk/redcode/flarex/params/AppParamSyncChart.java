...
public class AppParamSyncChart extends Param implements CompoundButton.OnCheckedChangeListener {
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.sync_chart);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.sync_chart_description);
    ...
    @Override
    public void refresh() {
        boolean value = AppParameter.getBoolean(context, AppParameter.SYNC_CHART, false);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        AppParameter.setBoolean(context, AppParameter.SYNC_CHART, isChecked);
        paramSwitch.setOnCheckedChangeListener(this);
        setLoading(false);
    }
}
