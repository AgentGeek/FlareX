...
public class ParamAlwaysHTTPS extends Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/always_use_https
    private static final String KEY = "always_use_https";
    private static final String TAG = "Param-AlwaysHTTPS";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.always_use_https);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.always_use_https_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamAlwaysHTTPS.this);
