...
public class ParamAuthenticateOrigin extends Param implements CompoundButton.OnCheckedChangeListener {

    // GET https://api.cloudflare.com/client/v4/zones/ZONE-ID/settings/tls_client_auth
    private static final String KEY = "tls_client_auth";
    private static final String TAG = "Param-AuthenticateOrigin";
    ...
    public void onDraw(LayoutInflater inflater, LinearLayout parent, Zone zone) {
        ...
        ((TextView) root.findViewById(R.id.param_name)).setText(R.string.authenticate_origin_pulls);
        ((TextView) root.findViewById(R.id.param_description)).setText(R.string.authenticate_origin_pulls_description);
        ...
        getSetting(KEY, new CFApi.JSONListener() {
            ...
            public void onResult(JSONObject body) {
                ...
                try {
                    ...
                    paramSwitch.setOnCheckedChangeListener(ParamAuthenticateOrigin.this);
